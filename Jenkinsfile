...
sonar-scanner -Dsonar.projectKey=dott -Dsonar.sources=/usr/src -Dsonar.host.url="$SONAR_HOST_URL" -Dsonar.login="$SONAR_LOGIN" -Dsonar.go.coverage.reportPaths=/usr/src/coverage.out
'''
        }
